...
//    final interactiveQueriesRestService restService = startRestProxy(streams);
      final InteractiveQueriesRestService restService = startRestProxy(streams);
...
//  static interactiveQueriesRestService startRestProxy(final KafkaStreams streams) throws Exception {
//    final HostInfo hostInfo = new HostInfo("localhost", 7070);
//    final interactiveQueriesRestService
//            restService = new interactiveQueriesRestService(streams, hostInfo);
//    restService.start(7070);
//    return restService;
//  }
  ...
  static InteractiveQueriesRestService startRestProxy(final KafkaStreams streams) throws Exception {
    final HostInfo hostInfo = new HostInfo("localhost", 7070);
    final InteractiveQueriesRestService
            wordCountInteractiveQueriesRestService = new InteractiveQueriesRestService(streams, hostInfo);
    wordCountInteractiveQueriesRestService.start(7070);
