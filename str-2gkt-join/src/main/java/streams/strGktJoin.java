...
public class strGktJoin {
  ...
  public static KafkaStreams createStreams() {
    ...
    final GlobalKTable<String, String>
            threats2 =
            builder.globalTable("ioc-topic-keyed-2", Materialized.<String, String, KeyValueStore<Bytes, byte[]>>as("threat-store-2")
                    .withKeySerde(stringSerde)
                    .withValueSerde(stringSerde)
            );
    ...
    final KStream<String, String> joinedStream2 = procStream.join(threats2,
            (leftKey, leftValue) -> leftKey+"new", // new left side "key"
            (leftValue, rightValue) -> "left=" + leftValue + ", right=" + rightValue /* ValueJoiner */
    );
    ...
    joinedStream2.to("ktable-joined-topic", Produced.with(stringSerde,stringSerde));
    joinedStream2.to("ktable-joined-topic-2", Produced.with(stringSerde,stringSerde));
